...
$class=$_POST['class'];
mysqli_query($con,"INSERT INTO student_tbl(name,roll_no,class_id)VALUES('$name','$roll_no','$class')");
}
...
<div class="card-body">
 ...
 <div class="row mb-3"style="margin-left: 10%;">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="inputEmail3" name="rollnumber">
    </div>
  </div>
