...
if(isset($_POST['submit'])){
    $class=$_POST['class'];
    mysqli_query($con,"INSERT INTO class_tbl(class_name)VALUES('$class')");
    header("lacation:add_class.php");
...
<div class="card-body">
  ...
  <div class="row mb-2" style="margin-top: 5%;margin-left: 10%;">
    <label for="inputText3" class="col-sm-2 col-form-label">add class</label>
    <div class="col-sm-8">
      <input type="text" class="form-control" id="inputText3" name="class">
    </div>
  </div>
